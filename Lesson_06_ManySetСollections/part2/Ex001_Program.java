package Lesson_06_ManySetСollections.part2;
...
public class Ex001_Program {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("workers w1, w2, w3: " + workers);
        System.out.println("workers.contains(w4): " + workers.contains(w4));
